...
Techsvantage LLC          0          0        41             true
Innovarion LLC            0          0        21             true
SPARK Services            3          3        4              false
Synovatech Inc            4          4        9              false
NEXCORE SOLUTIONS INC     4          4        4              false
```
...
user, "SPARK Emergency SMS", has **no email address**: `null` on the
